...
const app = getApp();
const questionCategoryUrl = app.globalData.serverUrl + "/app/service/customs/findByCustomsCategory.json";
const page_size = 10;
//获取排行榜
const findUserRankingListUrl = app.globalData.serverUrl + "/app/service/customs/findByCustomsRankingList.json";
Page({
  /**
   * 页面的初始数据
   */
